...
(: mul-sum-of (-> Integer Integer Integer))
(define (mul-sum-of num limit)
...
(define (muls-of-3-or-5 limit)
  (-
    (+ (mul-sum-of 3 limit) (mul-sum-of 5 limit))
    (mul-sum-of 15 limit))) ; Don't count multiples of both twice
